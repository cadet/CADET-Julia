...
#Setting up the model
    ...
    model.root.input.model.unit_001.discretization.npar = ncolPore #Should be high enough 
...
#According to Jans paper: k=[5,6,7,8,9], ncol = 2^k, npore=2^(k-2)
k = [4,5,6,7]
...
convergenceDataFV = pd.DataFrame({'DOF': DOF,'k': k,'runtime': runtime,'maxE': maxE_e,})
