...
model["root"]["input"]["model"]["connections"]["switch_000"]["dynamic_flow"] = true
model["root"]["input"]["model"]["connections"]["switch_000"]["connections"] =   [0, 1, -1, -1, 2/60, 0.001, 1e-5, 1e-6,
                                                                                1, 2, -1, -1, 2/60, 0.001, 1e-5, 1e-6]


model["root"]["input"]["model"]["connections"]["switch_001"] = OrderedDict()
model["root"]["input"]["model"]["connections"]["switch_001"]["section"] = 1
model["root"]["input"]["model"]["connections"]["switch_001"]["dynamic_flow"] = false
model["root"]["input"]["model"]["connections"]["switch_001"]["connections"] =   [0, 1, -1, -1, 2/60,
                                                                                 1, 2, -1, -1, 2/60]
